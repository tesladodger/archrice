...
" Normal Mode
let s:N1 = [ '#4A4A4A', '#3A3A3A', 254, 237 ]
let s:N2 = [ '#E4E4E4', '#4E4E4E', 254, 239 ]
let s:N3 = [ '#EEEEEE', '#262626', 255, 235 ]

" Insert Mode
let s:I1 = [ '#0a9dff', '#3a3a3a', 39, 237 ]

" Visual Mode
let s:V1 = [ '#4a4a4a', '#3a3a3a', 214, 237 ]
...
let g:airline#themes#minimalist#palette.insert   = airline#themes#generate_color_map(s:I1, s:N2, s:N3)
let g:airline#themes#minimalist#palette.visual   = airline#themes#generate_color_map(s:V1, s:N2, s:N3)
